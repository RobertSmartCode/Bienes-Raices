<main class="contenedor seccion">
    ...
    <form data-cy="formulario-contacto" class="formulario" accion="/contacto" method="POST">
        <fieldset>
        ...
        <fieldset>
            ...
            <input data-cy="input-precio" type="number" placeholder="Tu Precio o Presupuesto" id="presupuesto"
        ...
        <fieldset>
            ...
            <div class="forma-contacto">
                ...
                <input data-cy="forma-contacto" type="radio" value="telefono" id="contactar-telefono"
                    name="contacto[contacto]">


                <label for="contactar-email">E-mail</label>
                <input data-cy="forma-contacto" type="radio" value="email" id="contactar-email"
                    name="contacto[contacto]">
